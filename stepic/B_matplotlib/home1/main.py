...
# 1. График зависимости количества сотрудников сгруппированных по уровню образования
...
# 4. График зависимости оплаты от образования. Вывод: уровень оплаты труда не зависит от образования
...
# 5. График зависимости оплаты от образования.
